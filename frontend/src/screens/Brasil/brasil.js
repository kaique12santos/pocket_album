...
const FaCrown = (props) => <FontAwesome5 name="crown" {...props} />;
...
const BASE_BRASIL_URL = 'https://yybmqwzposqlwuomnzgc.supabase.co/storage/v1/object/public/pocket-album-images/Brasil/';

const flagImage = { uri: `${BASE_BRASIL_URL}Brasil.jpeg` };
const cbfImage = { uri: `${BASE_BRASIL_URL}cbf.jpeg` };
const epicCbfImage = { uri: `${BASE_BRASIL_URL}cbf-epica.png` };
const legendsImage = { uri: `${BASE_BRASIL_URL}jogadores-epicos.png` };
const zagalloImage = { uri: `${BASE_BRASIL_URL}zagalo.png` };
