...
const FaFutbol = (props) => <FontAwesome5 name="futbol" {...props} />;
const FaLayerGroup = (props) => <FontAwesome5 name="layer-group" {...props} />;
const FaGlobeAmericas = (props) => <FontAwesome5 name="globe-americas" {...props} />;
const FaStar = (props) => <FontAwesome5 name="star" {...props} />;
const FaShieldAlt = (props) => <FontAwesome5 name="shield-alt" {...props} />;
const FaMapMarkedAlt = (props) => <FontAwesome5 name="map-marked-alt" {...props} />;
const FaPaw = (props) => <FontAwesome5 name="paw" {...props} />;
...
const BASE_STADIUMS_URL = 'https://yybmqwzposqlwuomnzgc.supabase.co/storage/v1/object/public/pocket-album-images/stadiums/';

const stadiumImages = {
  'AT&T Stadium': { uri: `${BASE_STADIUMS_URL}att-stadium.jpg` },
  'MetLife Stadium': { uri: `${BASE_STADIUMS_URL}metlife-stadium.png` },
  'Mercedes-Benz Stadium': { uri: `${BASE_STADIUMS_URL}Mercedes_Benz_Stadium.jpg` },
  'Arrowhead Stadium': { uri: `${BASE_STADIUMS_URL}Arrowhead_Stadium.jpg` },
  'NRG Stadium': { uri: `${BASE_STADIUMS_URL}Nrg_stadium.jpg` },
  "Levi's Stadium": { uri: `${BASE_STADIUMS_URL}Levi's_Stadium.jpg` }, // Cuidado com a aspa simples aqui no nome do arquivo ao subir pro banco!
  'SoFi Stadium': { uri: `${BASE_STADIUMS_URL}SoFi_Stadium_2023.jpg` },
  'Lincoln Financial Field': { uri: `${BASE_STADIUMS_URL}Lincoln_Financial_Field.jpg` },
  'Lumen Field': { uri: `${BASE_STADIUMS_URL}Lumen-field.jpg` },
  'Gillette Stadium': { uri: `${BASE_STADIUMS_URL}Gillette_Stadium.jpg` },
  'Hard Rock Stadium': { uri: `${BASE_STADIUMS_URL}Hard_Rock_Stadium.jpg` },
  'Estadio Azteca': { uri: `${BASE_STADIUMS_URL}Estadio_Azteca.jpg` },
  'Estadio BBVA': { uri: `${BASE_STADIUMS_URL}Estadio_BBVA.jpeg` },
  'Estadio Akron': { uri: `${BASE_STADIUMS_URL}Estadio_Akron.jpg` },
  'BC Place': { uri: `${BASE_STADIUMS_URL}BC_Place.jpg` },
  'BMO Field': { uri: `${BASE_STADIUMS_URL}Toronto_BMO_Field.jpg` },
};
